...
class RISurConvSetAbstraction(nn.Module):
    ...
    def forward(self, xyz, norm, points):
        ...
        ri_feat = self.self_attention_0(ri_feat)//删除的部分
        ...
        risur_feat = self.self_attention_1(risur_feat)#删除的部分
        # res1 = risur_feat #添加三行
        # attn1 = self.self_attention_1(risur_feat)
        # risur_feat = res1 + attn1
